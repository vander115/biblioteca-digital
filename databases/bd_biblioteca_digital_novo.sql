...
--
-- Banco de dados: `bd_biblioteca_digital_novo`
--
CREATE DATABASE IF NOT EXISTS `bd_biblioteca_digital_novo` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `bd_biblioteca_digital_novo`;
